...
resultats_elections_data = pd.read_excel('resultats-par-niveau-cirlg-t2-france-entiere_1.xlsx')
# Charger les données électorales présidentielles 2017
resultats_elections_data_dix_sept = pd.read_excel('Presidentielle_2017_Resultats_Communes_Tour_2_c.xlsx')
